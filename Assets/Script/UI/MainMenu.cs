...
public class MainMenu : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        gameLogo.GetComponent<RectTransform>().anchoredPosition = new Vector3(-720, 300, 0);
        gameLogo.GetComponent<RectTransform>().DOAnchorPos(new Vector2(0, 300), 2f, false).SetEase(Ease.OutElastic).SetUpdate(true);
